Comandos Git
Git clone = clonar / baixar arquivo da nuvem, no computador local. 
Git init = Inicializa um novo repositório local vazio.
Git commit = checkpoint 
Git push = salvar na nuvem
Git pull = puxar nuvem salva   
Git add. = Adicionar a área de preparação(Stage) pra mandar pra nuvem 
Git reset = É o oposto do git add
